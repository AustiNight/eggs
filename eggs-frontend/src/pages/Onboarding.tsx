...
export default function Onboarding() {
  ...
  return (
    <div className="min-h-screen px-4 py-12" style={{ backgroundColor: '#0d1117' }}>
      <div className="max-w-lg mx-auto">
        <div className="text-center mb-10">
          <div className="text-4xl font-bold mb-2" style={{ color: '#f59e0b' }}>Welcome 👋</div>
          <p className="text-white text-lg font-semibold">Let's set up your chef profile</p>
          <p className="text-sm mt-1" style={{ color: '#8b949e' }}>Takes 60 seconds. Used to find prices near you.</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="rounded-xl p-6 space-y-4" style={{ backgroundColor: '#161b22', border: '1px solid #30363d' }}>
            <div>
              <label className="block text-xs font-semibold mb-1" style={{ color: '#8b949e' }}>Your Name</label>
              <input
                type="text"
                required
                value={displayName}
            ...
            <div>
              ...
              <input
                ...
                style={{ backgroundColor: '#0d1117', border: '1px solid #30363d' }}
              />
              <p className="text-xs mt-1" style={{ color: '#8b949e' }}>Used as default location for all shopping plans</p>
            </div>

            <div>
              <label className="block text-xs font-semibold mb-1" style={{ color: '#8b949e' }}>
                Default Search Radius: <span style={{ color: '#f59e0b' }}>{radius} mi</span>
              </label>
              <input
            ...
            <div>
              <label className="block text-xs font-semibold mb-1" style={{ color: '#8b949e' }}>
                Default Max Stores: <span style={{ color: '#f59e0b' }}>{maxStores}</span>
              </label>
              <input
            ...
            <div>
              <label className="block text-xs font-semibold mb-1" style={{ color: '#8b949e' }}>Stores to Avoid (optional)</label>
