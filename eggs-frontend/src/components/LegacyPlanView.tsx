/**
 * LegacyPlanView — the original per-store card rendering extracted from PlanResult.tsx.
 *
 * Rendered when plan.winners is absent/empty (SHOPPING_V2 flag off, or old plan).
