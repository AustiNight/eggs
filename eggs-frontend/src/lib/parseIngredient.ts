// Unified ingredient parser — frontend twin (independent of eggs-api)
//
// Parses free-text ingredient strings into structured { name, quantity, unit, rawInput }.
// Canonical unit is 'each' for bare countables; mirrors the backend twin's behaviour exactly.
...
// Extended from displayUnits.ts UNIT_ALIASES with produce/culinary units.
